// Mori: presents the Mori SwiftUI chrome behind Chrome's BrowserWindow
// interface so Chrome's Browser/TabStripModel — and the real extension
// system — drive Mori's UI instead of Chrome's views UI.
...
// payment/print sheets — over the shared Mori window. This single host is
